...
model_1 = "models/params80Mdata78M.h5" # big model on big dataset (overfitting, worst model)
model_2 = "models/params0.7Mdata2M.h5" # small model on small dataset
model_3 = "models/params1.3Mdata2M.h5" # big model on small dataset (best model)
